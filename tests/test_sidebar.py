...
def test_sidebar_new_lkz(base_fixture, domain):
...
def test_sidebar_new_lke(base_fixture, domain):
    # Инициализация базовых объектов через фикстуру
    base, sidebar = base_fixture
    ...
    sidebar.move_and_click(move_to=sidebar.documents_hover, click_to=sidebar.transport_doc_new_list_button,
                           do_assert=True, wait="lst")
    sidebar.move_and_click(move_to=sidebar.documents_hover, click_to=sidebar.reg_client_create_list_button,
                           do_assert=True, wait="lst")
    sidebar.move_and_click(move_to=sidebar.documents_hover, click_to=sidebar.reg_producer_create_list_button,
                           do_assert=True, wait="lst")
...
def test_sidebar_new_lkp(base_fixture, domain):
    # Инициализация базовых объектов через фикстуру
    base, sidebar = base_fixture
    ...
    # Рейсы (OLD)
    sidebar.move_and_click(move_to=sidebar.orders_old_hover_lkp, click_to=sidebar.monitor_button)
