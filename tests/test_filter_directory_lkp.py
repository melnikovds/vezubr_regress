...
def test_tariff_directory_lkp(base_fixture, domain):
    ...
    add.verify_text_on_page(text='10.12.2024', should_exist=True)
    ...
    add.verify_text_on_page(text='10.12.2024', should_exist=False)
    add.verify_text_on_page(text='ПРР-20241209145054', should_exist=False)
    add.verify_text_on_page(text='212151', should_exist=False)
    time.sleep(2)
...
def test_driver_directory_lkp(base_fixture, domain):
    ...
    time.sleep(3)
    add.verify_text_on_page(text='нетзаказов', should_exist=True)
...
def test_vehicle_directory_lkp(base_fixture, domain):
    ...
    f = Filter(base.driver)
    f.click_button(f.add_filter_vehicle)
    time.sleep(1)
    f.click_button(f.default_filter_vehicle)
    time.sleep(1)
    f.click_button(f.add_vehicle_filter_surname)
    time.sleep(1)
    f.click_button(f.add_vehicle_filter_name)
    time.sleep(1)
    f.click_button(f.add_vehicle_filter_patronymic)
    time.sleep(1)
    f.click_button(f.apply_filter_vehicle)
    time.sleep(1)
...
def test_tractor_directory_lkp(base_fixture, domain):
    ...
    add.dropdown_without_input(add.status_in_system_two, option_text='Активный')
    time.sleep(3)
    add.verify_text_on_page(text='ААААНР', should_exist=True)
    time.sleep(2)

    # проверка №1 фильтра "Статус в рейсе"
    add.dropdown_without_input(add.status_on_flight_two, option_text='Нет заказов')
    time.sleep(2)
    add.verify_text_on_page(text='НЕТДДДЗАКАЗОВ', should_exist=True)
...
def test_trailer_directory_lkp(base_fixture, domain):
    ...
    add.input_in_field(add.trailer_number, value='445', click_first=True)
    time.sleep(2)
    add.verify_text_on_page(text='АПП44445', should_exist=True)
    ...
    add.input_in_field(add.trailer_number, value='63933', click_first=True)
    time.sleep(3)
