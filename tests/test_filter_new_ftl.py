...
@allure.description('ЛКЭ, Тестирование фильтров новые доставки груза')
@pytest.mark.parametrize('base_fixture', ['lkz'], indirect=True)  # Параметризация роли
def test_filters_new_ftl_lkz(base_fixture, domain):
    # Инициализация базовых объектов через фикстуру
    base, sidebar = base_fixture
    sidebar.move_and_click(move_to=sidebar.requests_hover, click_to=sidebar.ftl_active_requests_button,
